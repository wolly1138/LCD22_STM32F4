...
#define LCD_RST_H()		HAL_GPIO_WritePin(GPIOA, GPIO_PIN_9,GPIO_PIN_SET)
#define LCD_RST_L()		HAL_GPIO_WritePin(GPIOA, GPIO_PIN_9,GPIO_PIN_RESET)

#define LCD_RS_H()		HAL_GPIO_WritePin(GPIOC, GPIO_PIN_7,GPIO_PIN_SET)
#define LCD_RS_L()		HAL_GPIO_WritePin(GPIOC, GPIO_PIN_7,GPIO_PIN_RESET)

#define LCD_CS_H()		HAL_GPIO_WritePin(GPIOB, GPIO_PIN_6,GPIO_PIN_SET)
#define LCD_CS_L()		HAL_GPIO_WritePin(GPIOB, GPIO_PIN_6,GPIO_PIN_RESET)
